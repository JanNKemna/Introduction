...
nr2 = float(input("Please enter number 2: "))
nr3 = float(input("Please enter number 3: "))
nr4 = float(input("Please enter number 4: "))
nr5 = float(input("Please enter number 5: "))
nr6 = float(input("Please enter number 6: "))
